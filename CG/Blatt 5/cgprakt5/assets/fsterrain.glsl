...
void main()
{
    ...
    FragColor = mix(texture(DetailTex[0],Texcoord*Factor),texture(DetailTex[1],Texcoord*Factor),texture(MixTex,Texcoord)) * vec4(((DiffuseComponent + AmbientColor) + SpecularComponent),1);
}
