...
TerrainShader::TerrainShader(const std::string& AssetDirectory) : PhongShader(false), Scaling(1, 1, 1), MixTex(NULL), Factor(100)
{
	...
	FactorLoc = getParameterID("Factor");
